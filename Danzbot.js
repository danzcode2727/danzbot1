...
prefix = ","
name = "~ DANZ BOT"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI MEMBER DANZBOT"
rmenu = "HAI MEMBER DANZBOT👋 JANGAN LUPA DONASI YA :)"
botinfo = "UNTUK INVITE BOT SILAHKAN DONASI DULU YA :)"
limitt = 20
memberLimit = 2
ban = []
		...
		case 'daftar':
            ...
            break  
				...
				case 'owner':
                 ...
                 client.sendMessage(from, 'Jika Mau Save Chat Aja ^_^, Ntar Disave Back:)',text, { quoted: mek} )
                 break
                case 'fitnah':
                 if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
